...
public class RedisExecutors {
    ...
    public static RedisExecutor<?> get(Properties props) {
        ...
        case 1: {// sentinel
            ...
            executor = new SentinelJedisExecutorProxy(jedisSentinelPool)
                    .getExecutor();
        ...
        case 2: {// sharding
            ...
            ShardedJedisPool shardedJedisPool = new ShardedJedisPool(config,
                    shards);
            executor = new ShardedJedisExecutorProxy(shardedJedisPool)
                    .getExecutor();
        ...
        case 3: {// cluster
            List<String> uris = getUris(props, "redis.cluster.uri.");
            if (uris == null || uris.isEmpty()) {
                throw new ExceptionInInitializerError(
                        "cluster uris can not be null.");
            }
            ...
            executor = new ClusterJedisExecutorProxy(jedisCluster)
                    .getExecutor();
